...
/**
 * Compara dois Carros pelo seu consumo por km.
 * @author Eduardo Freitas Fernandes
 */
public class ConsumoKmComparator implements Comparator<Carro> {
    ...
    public int compare(Carro carro1, Carro carro2) {
        double c1 = carro1.consumoKm();
        double c2 = carro2.consumoKm();
