...
/**
 * Empresa que gere Carros de vários tipos, com um Conjunto.
...
public class CarRentalSet {
    ...
    /** Conjunto de Carros ordenados geridos pela empresa */
    private SortedSet<Carro> veiculos;


    // construtores

    /**
     * Construtor por omissão de um CarRentalSet
     */
    public CarRentalSet() {
        veiculos = new TreeSet<>(new CustoKmComparator());
    }

    /**
     * Construtor parametrizado de um CarRentalSet
     * @param veiculos Conjunto de Carros
     */
    public CarRentalSet(Set<Carro> veiculos) {
        this();
        veiculos.forEach(c -> this.veiculos.add(c.clone()));
    }

    /**
     * Construtor de cópia de CarRentalSet
     * @param other CarRentalSet a copiar
     */
    public CarRentalSet(CarRentalSet other) {
        this();
